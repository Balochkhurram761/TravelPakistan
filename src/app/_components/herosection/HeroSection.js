...
<span className='flex flex-col items-start gap-2 md:flex-col sm:items-start md:items-start lg:items-center lg:flex-row ' > Pakistan’s Top Tourism Destinations <a
  href=""
